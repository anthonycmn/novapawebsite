// Server-side data store for the Sweeney Todd staff dashboard (cloned from deh-db).
//
// WHY THIS EXISTS
...
const GATE = process.env.SWEENEY_GATE_WORD || "fleet";

const SB_URL = process.env.SWEENEY_SUPABASE_URL;
const SB_KEY = process.env.SWEENEY_SUPABASE_SERVICE_ROLE_KEY;
...
export const config = { path: "/api/sweeney-db" };
