...
Classes: Weekly classes Monday–Saturday, September 14 2026 – June 11 2027, $90/month per class (2 classes $150/mo, 3 classes $180/mo — a second class is only $60 more, a third only $30 more). Every class is theatre training. Dance — Ballet for Musical Theatre (5–8, and levels I & II for 9–11), Hip-Hop for Musical Theatre (5–8, 9–12), K-Pop Stage Performance (9–12, Saturdays); Theatre & Acting — Acting (5–8, 9–12), Improv for Actors (9–12, 13–17), Film & Television (13–17, Mondays 8:00–8:50pm, on-camera and self-tape); Musical Theatre — Musical Theatre (5–8), Musical Theatre Dance and Musical Theatre Acting (9–12, 13–17), Acting & Musical Theatre (9–12, Saturdays); Voice — Triple Threat Musical Theatre Training (13–17); Homeschool daytime classes Wednesdays (9–13); Adults 18+ — Adult Acting (Tue 7:30pm), Adult Dance for Musical Theatre (Thu 7:30pm), Adult Musical Theatre (Sat 9am). Schedule: https://www.northernvirginiaperformingarts.org/classes — Adult programs: https://www.northernvirginiaperformingarts.org/classes?age=adult
...
ACTIVE DISCOUNT (through August 15, 2026, applied automatically at checkout): every Broadway Bound program counts the same — summer camps, Frozen, The Little Mermaid, Mean Girls, the Dear Evan Hansen intensive, and the teen mainstage shows (Sweeney Todd, Hadestown). Per camper: 1 program = 10% off, 2 = 15% off each, 3 or more = 20% off each. The tiers are per camper, not across siblings; families still add every child's programs to one cart and check out once (one free family account covers the whole household). Day camps, classes, and coaching are outside the ladder — day camps take the 5% sibling discount, classes have their own bundle, and coaching is flat priced. DAY CAMP 5-PACK: book one camper into all 5 day camps in one checkout and the price is $349 flat ($69.80 a day instead of $79) — applied automatically, per camper (not shared between siblings). Book by Monday, September 21, 2026 and that camper also gets 2 free Snow Day camps. Register on the Day Camps tab at https://www.northernvirginiaperformingarts.org/register/?season=day CLASSES: 1 class $90/month, 2 classes $150/month, 3 classes $180/month per student (when a family mentions one class, point out the second is just $60 more a month) — and any family with a 2026-27 show registration gets their FIRST MONTH OF CLASSES FREE, applied automatically at class checkout. Each age group has limited slots — encourage early registration.
