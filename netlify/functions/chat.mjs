...
ACTIVE DISCOUNT (through August 15, 2026, applied automatically at checkout): every Broadway Bound show counts the same — summer camps, Frozen, The Little Mermaid, and Mean Girls. Per camper: 1 show = 10% off, 2 shows = 15% off each, 3 or more = 20% off each. The tiers are per camper, not across siblings; families still add every child's programs to one cart and check out once (one free family account covers the whole household). CLASSES: 1 class $90/month, 2 classes $159/month, 3 classes $199/month per student — and any family with a 2026-27 show registration gets their FIRST MONTH OF CLASSES FREE, applied automatically at class checkout. Each age group has limited slots — encourage early registration.
