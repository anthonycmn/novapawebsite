// End-of-day rehearsal report from the Sweeney Todd: School Edition staff dashboard, and
  ...
  <table cellpadding="0" cellspacing="0" style="width:100%;background:#f6f4ef"><tr><td align="center" style="padding:26px 12px">
    <table cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;background:#fff;border-radius:14px;overflow:hidden">
      ...
      <tr><td style="background:${NAVY};padding:26px 32px">
        ...
        <h1 style="margin:0;font-size:25px;color:#fff;font-weight:700">Sweeney Todd: School Edition</h1>
      ...
      <tr><td style="padding:24px 32px 28px">
        <p style="margin:0;font-size:12.5px;color:#999;line-height:1.6;border-top:1px solid #eee8dd;padding-top:14px">
          Generated from the Sweeney Todd: School Edition staff dashboard.<br>
...
export function reportText(r) {
  const L = [];
  L.push(`REHEARSAL REPORT — Sweeney Todd: School Edition`);
...
export function buyHtml(r) {
  ...
  <table cellpadding="0" cellspacing="0" style="width:100%;background:#f6f4ef"><tr><td align="center" style="padding:26px 12px">
    <table cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;background:#fff;border-radius:14px;overflow:hidden">
      ...
      <tr><td style="padding:24px 32px 28px">
        <p style="margin:0;font-size:12.5px;color:#999;line-height:1.6;border-top:1px solid #eee8dd;padding-top:14px">
          Sent from the Sweeney Todd: School Edition staff dashboard. Reply to this email to reach the production team.<br>
...
export const config = { path: "/api/sweeney-report" };
