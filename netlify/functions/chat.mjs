...
PERFORMANCE TIMES (same pattern for all three camps — the final Friday and Saturday of the session, by age group): Ages 5–9 perform Friday 5:00pm and Saturday 11:00am. Ages 9–12 perform Friday 7:00pm and Saturday 1:00pm. Ages 12–15 perform Saturday 4:00pm and Saturday 7:00pm. Technical Theatre crews work all performances. Every camper performs twice.
ACTIVE DISCOUNT (through August 15, 2026, applied automatically at checkout): 10% off any camp, 15% off each camp when registering for two camps, 20% off each camp when registering for three. The multi-camp tiers work across kids and shows — families add each child's camp to one cart and check out once (one free family account covers the whole household). Each age group has limited slots — encourage early registration. Campers can do one, two, or all three shows.

Broadway Bound Teen (formerly Teen Conservatory): Audition-based teen track, ages 13–18 — the next step for Broadway Bound graduates. Intensive professional-track training in acting, dance, voice, musical theatre; includes dual-enrollment (DE) program. This season's casts are already set (Dear Evan Hansen HS Version August 2026, Sweeney Todd School Edition October 2026, Hadestown Spring 2027); cast members register through their HiSawyer account. Teens who want to perform this season should look at Frozen Teens and The Little Mermaid Teens — register at https://www.northernvirginiaperformingarts.org/register/
